      ...
      <main className="cart-main-content">
        ...
        {items.length === 0 ? (
          <div className="empty-cart">
            ...
            <p className="empty-cart-message">Sepertinya Anda belum menambahkan apa pun ke keranjang belanja Anda.</p>
            ...
            <div className="cart-items-column">
              <div className="cart-items-card">
                <div className="cart-card-header">
                  <h2 className="cart-card-title">Item di Keranjang ({items.length})</h2>
                </div>
